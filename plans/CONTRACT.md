...
`NEXT_PUBLIC_DEFAULT_RADIUS_METERS`, `NEXT_PUBLIC_LOCATION_REFRESH_METERS`,
`NEXT_PUBLIC_ALERT_SEVERITY_MIN`, `NEXT_PUBLIC_ALERT_RADIUS_METERS`,
`NEXT_PUBLIC_VENUE_NAME`, `NEXT_PUBLIC_VENUE_CITY`, `NEXT_PUBLIC_OPENAI_REALTIME_URL`.
